...
$('#signin').on('submit', function(e) {
  e.preventDefault();
  var password = $('.windows10-signin__password-input').val();
  if (password === 'pplg') {
    $('.windows10-signin').hide();
    $('#getready').removeClass('process');
    $('#getready').addClass('onprocess');
    setWelcome();
    setTimeout(function() {
        $('#getready').addClass('done');
    }, 15000);
  } else {
...
var gettingReadyText = $('.windows10-signin__getting-ready-text');
var gettingReadyProgress = $('.windows10-signin__getting-ready-progress');
var texts = ["Keep coding and inspiring us, Mem!", "Loading..."];
var progress = 0;
var currentText = 0;
function setWelcome() {
    setInterval(function() {
      gettingReadyText.text(texts[currentText]);
